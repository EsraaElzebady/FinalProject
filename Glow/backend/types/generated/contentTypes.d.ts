...
export interface ApiCartCart extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cartItem: Schema.Attribute.Component<'product.cart-item', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiNewNew extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::new.new'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    new_author: Schema.Attribute.String;
    new_date: Schema.Attribute.Date;
    new_img: Schema.Attribute.Media<
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    addedImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    deletedprice: Schema.Attribute.String;
    ...
    product_status: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    ...
    VariantProduct: Schema.Attribute.Component<
